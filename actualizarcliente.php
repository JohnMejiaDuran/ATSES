<?php require('./layout/header.php') ?>
    ...
    <div class="contact_form">
        <div class="formulario">      
            <h1 class="titulo__formulario">Actualización de Clientes</h1>
            <h3 class="titulo1">Resgitre los datos basicos de clientes. </h3>
        </div>
        ...
        <form action="" method="post">       
            <div class="columnas" >
                ...
                <div>
                    <label for="Apellidos" class="colocar_nombre">Apellidos
                      <span class="obligatorio">*</span>
                    </label>
            ...
            <h3>Resgitre los datos de contacto de clientes. </h3>  
          <div class="columnas">
            <div>
            ...
            <div>
              <label for="email" class="colocar_email">Email
                ...
                <div class="button__submitregistrocliente">
                    <button  type="submit" name="enviar_formulario" id="enviar"><a class="enviar">Guardar</a></button>
                </div>
                <div class="aviso">
