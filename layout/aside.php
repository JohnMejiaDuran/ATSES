...
<aside class="aside"> 
                    <a href="http://localhost/ATSES/index.php" class="aside__logo"> 
                    ...
                    <li class="aside__father">
                       ...
                       <div class="aside__content">
                           <ul class="aside__sub" >
                           <li class="aside__son"><a class="aside__son-link" href="http://localhost/ATSES/cotizacion.php">Crear Cotización</a></li> <!--Hijo-->
